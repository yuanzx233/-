...
TD=ROOT/'resources/house-templates/HT-T010';SRC=TD/'source/HT_T010_V0.1_SOURCE.dxf';OUT=TD/'preview/HT_T010_V0.1_TWO_FLOOR_REVIEW_BASE.png'
...
panels=[('一层平面图',(20500,-500,40500,10500)),('二层平面图',(53200,-500,73200,10500))]
...
d.text((45,25),'HT-T010 二层五房｜一层、二层独立复核底图',font=title,fill=(20,35,45));d.text((48,66),'深蓝=墙体｜青色=门窗｜紫色=楼梯｜灰色=轴线；两层须分别确认外墙、房间与楼梯关系',font=small,fill=(70,80,88))
