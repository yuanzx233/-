...
TD=ROOT/'resources/house-templates/HT-T011';SRC=TD/'source/HT_T011_V0.1_SOURCE.dxf';OUT=TD/'preview/HT_T011_V0.1_TWO_FLOOR_REVIEW_BASE.png'
...
panels=[('一层平面图',(30000,-2500,47000,10500)),('二层平面图',(63700,-2500,80700,10500))]
...
d.text((45,25),'HT-T011 二层四房｜一层、二层独立复核底图',font=title,fill=(20,35,45));d.text((48,66),'深蓝=墙体｜青色=门窗｜紫色=楼梯｜灰色=轴线；两层须分别确认外墙、房间与楼梯关系',font=small,fill=(70,80,88))
