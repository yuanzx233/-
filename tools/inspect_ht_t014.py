...
SRC = TD / "source/HT_T014_V0.1_SOURCE.dxf"
OUT = TD / "preview/HT_T014_V0.1_TWO_FLOOR_REVIEW_BASE.png"
...
d.text((45, 25), "HT-T014 二层三房｜一层、二层独立复核底图", font=title, fill=(20, 35, 45))
