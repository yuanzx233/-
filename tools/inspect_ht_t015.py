...
TD = ROOT / "resources/house-templates/HT-T015"
SRC = TD / "source/HT_T015_V0.1_SOURCE.dxf"
OUT = TD / "preview/HT_T015_V0.1_TWO_FLOOR_REVIEW_BASE.png"
...
panels = [("一层平面图", (30000, -2500, 45500, 10500)), ("二层平面图", (63700, -2500, 79200, 10500))]
W, H = 1800, 900
...
d.text((45, 25), "HT-T015 二层四房｜一层、二层独立复核底图", font=title, fill=(20, 35, 45))
