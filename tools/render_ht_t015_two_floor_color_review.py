...
OUT = TD / "preview/HT_T015_V0.2_TWO_FLOOR_COLOR_REVIEW.png"
im = Image.open(TD / "preview/HT_T015_V0.1_TWO_FLOOR_REVIEW_BASE.png").convert("RGB")
...
mp=mapper(panels[1])
f2=[
 ("楼梯间",9.89,[(65546.02,5330.62),(67846.02,5330.62),(67846.02,9230.62),(65546.02,9230.62)]),
 ...
 ("卧室四",16.40,[(65546.02,-1569.38),(69546.02,-1569.38),(69546.02,2530.62),(65546.02,2530.62)])]
for i,x in enumerate(f2): zone(mp,*x,colors[i])
outer=[mp(x) for x in [(65346.02,9430.62),(78046.02,9430.62),(78046.02,2530.62),(69746.02,2530.62),(69746.02,-1769.38),(65346.02,-1769.38)]]
d.line(outer+[outer[0]],fill=(230,35,35,255),width=6)
im.save(OUT)
print(OUT)
